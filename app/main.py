...
from app.routers import auth, dashboard, counterparties, products, orders, invoices, contracts, settings, reports, warehouse
...
for _mod in [_r_auth, _r_dash, _r_cp, _r_prod, _r_ord, _r_inv, _r_con, _r_set, _r_rep, _r_wh]:
