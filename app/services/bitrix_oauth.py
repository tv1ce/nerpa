...
# placement обязателен для встраивания виджета: без него portal
# отвечает на placement.bind 401 «требуются более высокие привилегии»
DEFAULT_SCOPE = "crm,user,task,catalog,placement"
