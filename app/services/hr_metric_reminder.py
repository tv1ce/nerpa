...
метрику подразделения без входа в NERPA, а чат уведомлений общий — ссылку
...
def _base_url(db: Session) -> str:
    """Публичный адрес NERPA из настроек. Фоновой задаче взять его больше неоткуда
    ...
    не приводятся: они открывают форму подразделения без входа в NERPA, а чат
