    ...
    for i, item in enumerate(order.items, 1):
        ...
        if ext:
            ...
            zapasy.append({
                ...
                "Количество": qty,
                "Цена": price,
                # «Сумма»/«Всего» НЕ шлём — пусть 1С посчитает строку сама из Цены,
                # Количества и ручной скидки (как при ручном вводе оператором).
                # Явная «Сумма» перекрывала авто-расчёт и «Сумма» оставалась без скидки.
