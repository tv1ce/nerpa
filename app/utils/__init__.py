...
# «оплата счёта №35», «счет № 123», «сч. на оплату 77» → номер счёта из назначения платежа
_INV_NUM_RE = _re.compile(r"сч[её]?т\w*\.?\s*№?\s*(\d{1,7})", _re.IGNORECASE)
_ANY_NUM_RE = _re.compile(r"№\s*(\d{1,7})")
