...
Собирается из данных заказа TMS — БЕЗ 1С. Результат (windows-1251 XML) кладётся
...
def build_upd_xml(order, company) -> bytes:
    """Заказ TMS → формализованный УПД (СЧФДОП, КНД 1115131) в windows-1251."""
    ...
    xml = (
        ...
        f'ИдФайл="{_a(id_file)}" ВерсФорм="5.03" ВерсПрог="TMS">'
